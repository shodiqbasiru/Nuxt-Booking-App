<template>
  <PageContainer class="py-4 lg:py-32 flex flex-col items-center mt-8 lg:mt-20">
    <div>
      ...
      <p class="text-center mt-4 text-gray-600 dark:text-gray-400 w-full lg:w-[900px]">
    ...
    <div class="mt-16 grid grid-cols-6 gap-4">
      <div class="lg:col-span-2 md:col-span-3 col-span-6 bg-slate-200 dark:bg-gray-800 rounded-lg shadow-lg flex flex-col overflow-hidden">
        <div class="flex-1 overflow-hidden">
          <img
            src="~/assets/images/lr.jpg"
            alt="luxury-room"
            class="w-full h-64 object-cover brightness-75 hover:brightness-100 hover:scale-105 transition-all duration-300"
          />
        </div>
        <div class="p-4 lg:p-6 flex flex-col">
          <div class="flex-1">
            <h2 class="text-xl font-bold text-gray-950 dark:text-gray-50">Luxury Room</h2>
      ...
      <div class="lg:col-span-2 md:col-span-3 col-span-6 bg-slate-200 dark:bg-gray-800 rounded-lg shadow-lg flex flex-col overflow-hidden">
        ...
        <div class="p-4 lg:p-6 flex flex-col">
          <div class="flex-1">
            <h2 class="text-xl font-bold text-gray-950 dark:text-gray-50">Swimming Pool</h2>
            <p class="text-gray-600 dark:text-gray-400 mt-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
      ...
      <div class="lg:col-span-2 md:col-span-3 col-span-6 bg-slate-200 dark:bg-gray-800 rounded-lg shadow-lg flex flex-col overflow-hidden">
        ...
        <div class="p-4 lg:p-6 flex flex-col">
          <div class="flex-1">
            <h2 class="text-xl font-bold text-gray-950 dark:text-gray-50">Restaurant</h2>
            <p class="text-gray-600 dark:text-gray-400 mt-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
